...
i4 = User.create!(first_name: 'Alfredo', last_name: 'Milano', role: 'instructor', email: 'alfredo@alfredo.com', password: 'password', confirmed_at: Time.now)
i5 = User.create!(first_name: 'Johnnie', last_name: 'Byng', role: 'instructor', email: 'johnnie@johnnie.com', password: 'password', confirmed_at: Time.now)
...
g3 = Grade.create!(week: 3, week_start: (Time.now + (60*60*24*90)), user_id: 2)
...
m6 = Mark.create!(user_id: 4, grade_id: 3, classwork_effort: 1, classwork_achievement: 'A', homework_effort: 2, homework_achievement: 'B', comment: 'BLBLBLBLBLBLB!')
