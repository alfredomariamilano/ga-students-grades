...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date } }, as: :json
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date } }, as: :json
    assert_response 200
  end
